...
#[near_bindgen]
impl FungibleTokenCore for NativoToken {
    #[payable]
...
#[near_bindgen]
impl FungibleTokenResolver for NativoToken {
...
#[near_bindgen]
impl FungibleTokenMetadataProvider for NativoToken {
